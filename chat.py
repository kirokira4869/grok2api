...
class ChatCompletionRequest(BaseModel):
    ...
    search: Optional[bool] = Field(None, description="是否启用联网搜索")
    enable_search: Optional[bool] = Field(None, description="是否启用联网搜索（兼容字段）")
    tools: Optional[List[Dict[str, Any]]] = Field(None, description="工具列表，支持 web_search / web_search_preview")
